  ...
  static render() {
    ...
    return `
      ...
      <style>
        ...
        .target-word { margin-bottom: 24px; }
        .word-hint { font-size: 16px; color: #888; margin-bottom: 8px; }
        .word-display { font-size: 32px; font-weight: bold; color: var(--primary-pink); letter-spacing: 4px; }
        .puzzle-area { }
        .answer-slots { display: flex; justify-content: center; gap: 8px; margin-bottom: 20px; }
        .answer-slot { width: 50px; height: 60px; border: 3px solid var(--primary-blue); border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 28px; font-weight: bold; background: rgba(84, 160, 255, 0.1); cursor: pointer; transition: all 0.2s; }
        .answer-slot.filled { background: white; }
        .answer-slot:active { transform: scale(0.95); }
        .scrambled-letters { display: flex; justify-content: center; gap: 10px; flex-wrap: wrap; margin-top: 24px; }
        .scrambled-btn { width: 55px; height: 55px; font-size: 26px; font-family: 'ZCOOL KuaiLe', sans-serif; background: linear-gradient(135deg, var(--primary-green), #3DB9A8); color: white; border: none; border-radius: 12px; cursor: pointer; transition: all 0.2s; box-shadow: 0 4px 12px rgba(78, 205, 196, 0.3); }
        .scrambled-btn:active { transform: scale(0.9); }
